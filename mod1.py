...
print ("Roots of the funcion:")
print([xz1,yzs[0]])
print([xz2,yzs[1]])

print ("\nLocal min and max of the function:")
print("[Xmin, Ymin] ", [xz3,yzs[2]])
print("[Xmax, Ymax] ", [xz4,yzs[3]])
...
plot.ylabel('Y')
#plot.show()
plot.savefig("graphs/local_min_max.jpg")
